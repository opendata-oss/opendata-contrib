//! Iteration Protocol implementation for the real-CH
...
pub struct RealChConfig {
    ...
    /// Runtime options (defaults are the pipelined profile).
...
fn build_correctness(reports: &[RealChIterationReport], passed: bool) -> Value {
    ...
    json!({
        ...
        "summary": {
            ...
            "notes": "Counts-based correctness only. Full ack_invariant_checks land alongside the TestObservableSink trait refactor.",
        },
        "iterations": per_iter,
    })
}
