//! JSONEachRow serializer — the legacy `render_jsoneachrow` path
//! lifted into the `ChunkSerializer` trait so row 7.4 can land a
//! RowBinary serializer alongside without touching the writer.
//! Bit-identical output to the pre-7.3 writer.
