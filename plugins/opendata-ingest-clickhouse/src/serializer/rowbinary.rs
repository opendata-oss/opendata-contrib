//! RowBinaryWithNamesAndTypes serializer. Encodes the
...
/// string. The table is hardcoded for OTLP logs; pluggable schemas
/// would generalize this to a sink-side configurable mapping.
